...
const features = [
  ...
  },
  {
    ...
    description: "Minimal, distraction-free UI that stays out of your way when you need to focus.",
  },
  {
    icon: "🚀",
    title: "Lightning Fast",
    description: "Native desktop app with instant responses. No browser tabs, no lag.",
  },
  {
    icon: "🐧",
    title: "Linux Native",
    description: "Built for Linux first. macOS and Windows support coming soon.",
  },
];
    ...
    <section id="features" className="py-24 px-8 max-w-6xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-text-secondary text-lg max-w-2xl mx-auto">
          Built by developers, for developers. Every feature designed to give you the edge in
